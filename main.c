...
* File Name:   main.c
*
* Description: This is the source code for the T2G MCU P-DMA 1D transfer code
...
*********************************************************************************
* Summary:
* This is the main function. It configures P-DMA for 1D transfer of elements
* from source buffer to destination buffer, using button interrupt 
* to trigger the P-DMA transfer and results are printed on the serial terminal.
*
* Parameters:
*  none
*
...
int main(void)
{
    ...
    Cy_DMA_Descriptor_SetSrcAddress(&PDMA_Descriptor_0, (uint8_t *) srcBuffer);
    Cy_DMA_Descriptor_SetDstAddress(&PDMA_Descriptor_0, (uint8_t *) dstBuffer);
    ...
    printf("\x1b[2J\x1b[;H");
    printf("************************************************************\r\n");
    printf("P-DMA memory to memory transfer code example\r\n");
    printf("************************************************************\r\n\n");
    printf(">> Press USER_BTN1 to trigger a P-DMA memory to memory transfer \r\n\n");
    ...
    for (;;)
    {
        ...
        transferCount++;
        printf("[Transfer #%lu] Starting P-DMA memory to memory transfer \r\n\n", (unsigned long)transferCount);
        ...
        print_buffer("SRC", srcBuffer, BUFFER_SIZE);
        ...
        printf("P-DMA memory to memory transfer complete \r\n\n");

        /* Print destination buffer after transfer */
        printf("  Destination buffer (after transfer):\r\n");
        print_buffer("DST", dstBuffer, BUFFER_SIZE);
        printf("--------------------------------------------------------------\r\n\n");
